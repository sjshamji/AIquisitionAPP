import { Question } from '@/lib/api/openai';
...
// Import the questions data from the original file
// This is a workaround since we can't directly import the questionsData array
// We'll use a small subset of questions for now
